...
class CashCardApplicationTests {
    ...
    @Test
    void shouldReturnASortedPageOfCashCardsWhenAscending() {
        ResponseEntity<String> response = restTemplate.withBasicAuth("sarah1", "abc123").getForEntity("/cashcards?page=0&size=1&sort=amount,asc", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    void shouldNotDeleteACashCardThatDoesNotExist() {
        ResponseEntity<String> getResponse = restTemplate.getForEntity("/cashcards/99999", String.class);
